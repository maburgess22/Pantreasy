...
interface LowStockTabProps {
  ...
  lowStockDropdownRef: React.RefObject<HTMLDivElement>;
  ...
  newTrackCategory: string;
  setNewTrackCategory: (val: string) => void;
...
export default function LowStockTab({
  handleBackNavigation, lowStockDropdownRef, showAddTrackMenu, setShowAddTrackMenu,
  ...
  setNewTrackName, handleNewTrackNameChange, newTrackCategory, setNewTrackCategory,
  dynamicCategories, newTrackUnit, setNewTrackUnit, COMMON_UNITS, loading,
